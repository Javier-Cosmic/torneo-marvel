        ...
        <>
            ...
            <div className='container-battle'>
                <div className='game winner'>
                    ...
                    src={winner.img} alt='' width='200px' />
                    <div className='text-winner'>
                        <h1>{winner.name}</h1>
                        <h2>puntos: {winner.points}</h2>
                    </div>
                    <div className='flex-between'>
                    <button className='button btn-size' onClick={onPlay}>Volver a jugar</button>
                    <Link className='link-comic btn-winner' onClick={onPlay} to='/ranking'>Ver ranking</Link>
                    </div>
                </div>
            </div>
        </>
